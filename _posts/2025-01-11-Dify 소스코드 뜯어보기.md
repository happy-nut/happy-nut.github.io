...
description: "LLMOps 플랫폼 오픈소스인 Dify를 확장성 있게 셀프 호스팅하기 위해 소스코드를 분석한다. 폴더 구조 파악, 로컬 실행, API 코드 분석 등의 과정을 거치며 Dify의 전체 아키텍처를 이해하고, 오픈소스 프로젝트를 효과적으로 파악하는 노하우를 공유한다."
date: 2025-01-11 20:13:19 +0900
categories: [engineering, analysis]
tags: [dify, llm, sora, opensource]
image: /assets/img/posts/a5c230ec.png
mermaid: true
math: false
---

![Dify 메인 화면](https://private-user-images.githubusercontent.com/13230914/321628871-f9e19af5-61ba-4119-b926-d10c4c06ebab.png?jwt=eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9..RKWxhb2_HY2nfuy1Lwtsx6AAOdP6U2jUSx_R0n4d8ZE)
_Dify 공식 GitHub 저장소_
...
![Dify Docker 구조도](https://github.com/langgenius/dify/blob/main/docker/docker-compose.png?raw=true)
_Dify 공식 Docker Compose 구조도_
...
![Dify DB 접속 화면](/assets/img/posts/5743cf1e.png)
_로컬에서 Dify DB에 접속한 모습_
